...
The Wordlist allows users to review individual words and the places in the text where they are used. This can help with the spelling review process and ensure consistency.
...
- `src/` contains the source code for the extension
  ...
  - `src/types/paratext-bible-word-list.d.ts` is this extension's types file that defines how other extensions can use this extension through the `papi`. It is copied into the build folder
