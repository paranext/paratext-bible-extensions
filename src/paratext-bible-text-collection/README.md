...
The text collection extension for Paratext 10 Studio allows users to see one verse from several different project or resource texts all at the same time.
